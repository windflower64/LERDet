...
class Silence(nn.Module):
    """Identity module used as a compatibility root for branched RGBT YAMLs."""
...
class SilenceChannel(nn.Module):
    """Slice a contiguous channel range from an input tensor."""

    def __init__(self, c_start: int, c_end: int):
        super().__init__()
